...
Unfortunately, we don't know what offset the latter half will be at, so we'll simply test each of the three possible offsets and abort if none of them work:
